        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="p-6 bg-white rounded shadow">
            ...
            <p className="text-gray-700">
              Create and join virtual study rooms to collaborate with peers on specific subjects or
              topics.
            </p>
          </div>
          <div className="p-6 bg-white rounded shadow">
            ...
            <p className="text-gray-700">
              Communicate with study group members using a real-time messaging system, fostering
              instant collaboration and knowledge sharing.
            </p>
          </div>
          <div className="p-6 bg-white rounded shadow">
          ...
          <div className="p-6 bg-white rounded shadow">
            <h3 className="text-xl font-semibold mb-2">Virtual Whiteboard</h3>
            <p className="text-gray-700">
              Collaborate in real-time using a shared virtual whiteboard, enabling students to
              brainstorm ideas, solve problems, and visually present concepts.
            </p>
          </div>
          <div className="p-6 bg-white rounded shadow">
          ...
          <div className="p-6 bg-white rounded shadow">
            <h3 className="text-xl font-semibold mb-2">Notifications and Reminders</h3>
            <p className="text-gray-700">
              Stay organized with study reminders and notifications, ensuring that students never
              miss an important study session.
            </p>
          </div>
        </div>
      </div>
