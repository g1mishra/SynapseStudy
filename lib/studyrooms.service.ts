...
export async function joinStudyRoom([_url, payload]: [string, UserLinksI]): Promise<UserLinksModel | any> {
...
export async function leaveStudyRoom([_url, studyRoomId, userId]: [string, string, string]): Promise<any> {
...
export async function createStudyRoom([_url, userId, data]: [string, string, StudyRoomI]): Promise<StudyRoomModel | any> {
  const { name, description, image_url, subject } = data;
...
export async function updateStudyRoom([_url, data]: [string, StudyRoomModel]): Promise<StudyRoomModel | any> {
  const { name, description, image_url, subject,$id :studyRoomId  } = data;
...
export async function deleteStudyRoom([_url, studyRoomId]: [string, string]): Promise<any> {
